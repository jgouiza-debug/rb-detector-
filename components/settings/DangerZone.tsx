  ...
  return (
    <>
      ...
      <Sheet open={open} onClose={() => setOpen(false)} title="delete everything?">
        ...
        <input value={confirm} onChange={(e) => setConfirm(e.target.value)} aria-label="type delete to confirm" className="mb-4 w-full rounded-2xl border border-line bg-surface px-4 py-3 outline-none focus-visible:outline-3 focus-visible:outline-ring" />
