...
export function HelpNowCard() {
  return (
    <Link href="/help" className="tap flex items-center gap-4 rounded-card bg-blush/25 p-4 dark:bg-surface dark:ring-1 dark:ring-blush/30">
      <span className="grid size-10 place-items-center rounded-full bg-blush/50 text-blush-ink dark:bg-blush/15 dark:text-blush"><Icon icon={HeartHandshake} size={20} /></span>
      <span>
