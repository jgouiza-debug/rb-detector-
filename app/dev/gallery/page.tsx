  ...
  return (
    <main id="main" className="mx-auto w-full max-w-2xl space-y-8 p-6">
      ...
      <section className="space-y-4">
        <h2 className="font-display text-lg">meditation frames</h2>
        <p className="text-sm text-fg-soft">Cut from the reference sheet; the Remotion composition crossfades them with the breath.</p>
