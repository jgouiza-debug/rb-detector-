...
export default function GalleryPage() {
  ...
  return (
    <main id="main" className="mx-auto max-w-2xl space-y-8 p-6">
      <h1 className="font-display text-3xl">pip gallery</h1>
      <section>
        <h2 className="mb-3 font-display text-xl">expressions</h2>
      ...
      <section className="space-y-3">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Button variant="strong">Unlock with Pip+</Button>
          <Button variant="soft">not now</Button>
          <Button variant="ghost">skip</Button>
        </div>
      </section>
      <section className="space-y-3">
        <h2 className="font-display text-xl">moods</h2>
      ...
      <section className="space-y-3">
        <h2 className="font-display text-xl">bubbles</h2>
        <div className="flex flex-col gap-2">
          <div className="bubble-pip max-w-[80%] self-start bg-bubble-pip px-4 py-2.5 text-bubble-pip-fg">that sounds like a lot to carry today.</div>
          <div className="bubble-pip no-tail max-w-[80%] self-start bg-bubble-pip px-4 py-2.5 text-bubble-pip-fg">do you want to get into it, or just let it out?</div>
          <div className="bubble-user max-w-[80%] self-end bg-bubble-user px-4 py-2.5 text-bubble-user-fg">honestly just let it out for a sec</div>
        </div>
      </section>
    </main>
  );
